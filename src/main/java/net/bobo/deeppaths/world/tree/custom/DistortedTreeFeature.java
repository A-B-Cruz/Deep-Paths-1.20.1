...
public class DistortedTreeFeature extends Feature<TreeFeatureConfig> implements FeatureConfig {
    private static final int FORCE_STATE_AND_NOTIFY_ALL = 19;

	public DistortedTreeFeature(Codec<TreeFeatureConfig> codec) {
        super(codec);
    }
    ...
    @Override
    protected void setBlockState(ModifiableWorld world, net.minecraft.util.math.BlockPos pos, BlockState state) {
    ...
    private static VoxelSet placeLogsAndLeaves(
            WorldAccess
    world, BlockBox box, Set< net.minecraft.util.math.BlockPos > trunkPositions, Set< net.minecraft.util.math.BlockPos > decorationPositions, Set< net.minecraft.util.math.BlockPos > rootPositions
	) {
